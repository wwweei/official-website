...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveComNews(fag){
            ...
            $.ajax({
                //几个参数需要注意一下
                type: "POST",//方法类型
                url: "/official-website/comNewsAction/saveComNews.action",//url
                data: formData,
                success: function () {
                    alert("成功");
    ...
    <script>
        KindEditor.ready(function(K) {
	        	var options = {
		                filterMode : true,
		                uploadJson: '/official-website/comNewsAction/uploadComNewsPic.action',//指定上传图片的服务器端程序
...
<body>
    <form name="fr" id="fr" action="#" method="post" style="text-align: center">
        ...
        <hr>
        <div>
            <input type="button" id="publishBtn" value="发表" onclick="saveComNews('1');"/>&nbsp;&nbsp;|&nbsp;
            <input type="button" id="saveBtn" value="保存" onclick="saveComNews('0');"/>&nbsp;&nbsp;|&nbsp;
