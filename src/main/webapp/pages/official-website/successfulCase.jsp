  ...
  <div class="content_box2"> 
    ...
    <div class="content_boxL">
       <div class="content_boxL_nav">
         <p class="content_boxL_nav_title">成功案例</p>
         <div class="content_boxL_nav_R"><a href="">首页 </a> > <a href="">成功案例</a></div>                          
       </div>
       <div class="content_boxL_text">
         <ul class="content_boxL_list">
         	<c:forEach var="news" items="${caseList }">
   ...
   <div class="info_search">
    ...
    <div class="info_search_r"><a href=""><img src="images/icon6.png"/><span>微信</span></a></div>
   </div>
   </div>
