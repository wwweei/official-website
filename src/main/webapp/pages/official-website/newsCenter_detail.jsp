  ...
  <div class="content_box2"> 
    ...
    <div class="content_boxL">
       <div class="content_boxL_nav">
         ...
         <div class="content_boxL_nav_R" id="titlePath"><a href="/official-website/pages/official-website/index.html">首页</a> > <a href="/newsCenterAction/getNewsList.action">新闻中心</a></div>                          
       </div>
       <div class="content_boxL_text">
          <p class="xqy_news_title">${news.title }<br /><span>发布时间：<fmt:formatDate value="${news.saveTime }" type="date"/>     来源：${news.author }</span></p>   
          <div class="xqy_news_title1">
            ${news.content }
          </div> 
       </div>
    </div>
